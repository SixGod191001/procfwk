...
|:--------:|--------------|--------|
|   3.0    |Replace the framework's Azure Function activity with a web activity. The framework is more lightweight, making it easier for engineers who don’t understand C# code to learn and develop. |
